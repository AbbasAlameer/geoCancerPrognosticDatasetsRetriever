...
## Installation
geo_Cancer_Prognostic_Datasets_Retriever can be used on any Linux or macOS machines. To run geo_CPDR, you need to have the following programs installed on your computer:

<p><ul><li>Perl (version 5.30.0 or later)</li></ul></p>
<p><ul><li>cURL (version 7.68.0 or later)</li></ul></p>

By default, Perl is installed on all Linux or macOS operating systems. Likewise, cURL is installed on all macOS versions. cURL may not be installed on Linux and would need to be manually installed through a Linux distribution’s software centre. However, geo_Cancer_Prognostic_Datasets_Retriever will install it automatically on Ubuntu linux.
...
## Support
<address>For support of geo_Cancer_Prognostic_Datasets_Retriever, please email <a href="mailto:abbas.alameer@ku.edu.kw">Abbas Alameer.</a></address>
